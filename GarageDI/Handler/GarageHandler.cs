...
namespace GarageDI.Handler
{
    class GarageHandler : IGarageHandler
    {
        ...
        {
            ArgumentNullException.ThrowIfNull(vehicleProp.Item1, nameof(vehicleProp.Item1));
            ArgumentNullException.ThrowIfNull(vehicleProp.Item2, nameof(vehicleProp.Item2));
